...
DATASET_PATH = Path(__file__).resolve().parent / "data" / "milestone_11_5_alpha_portfolio_dataset.csv"
DEFAULT_OUTPUT_ROOT = Path(__file__).resolve().parent / "output" / "milestone_11_5_alpha_portfolio_workflow"
...
def build_fixed_split(frame: pd.DataFrame) -> Any:
    ...
    return make_alpha_fixed_split(
        ...
        metadata={"example": "milestone_11_5"},
    )
...
def print_summary(summary: dict[str, Any], output_root: Path) -> None:
    print("Milestone 11.5 Alpha & Portfolio Workflow Example")
    ...
    *,
    ...
    write_portfolio_artifacts(
        ...
        portfolio_config_dict(
            portfolio_name="milestone_11_5_example_baseline",
            execution_config=execution_config,
    ...
    write_portfolio_artifacts(
        ...
        targeted_metrics,
        portfolio_config_dict(
            portfolio_name="milestone_11_5_example_targeted",
            execution_config=execution_config,
