...
- **Transition effects.** A strategy may behave differently *around* regime changes. M24.3 does not compute transition-specific analysis. That belongs to later M24 work.
