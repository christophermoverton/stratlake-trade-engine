    ...
    *,
    ...
    return {
        ...
        "metrics": {
            ...
            "value_at_risk": _coerce_number(metrics.get("value_at_risk")),
            "conditional_value_at_risk": _coerce_number(metrics.get("conditional_value_at_risk")),
        ...
        "risk": {
            ...
            "rolling_volatility_window": _coerce_number(metrics.get("rolling_volatility_window")),
            "rolling_volatility_latest": _coerce_number(metrics.get("rolling_volatility_latest")),
            "rolling_volatility_mean": _coerce_number(metrics.get("rolling_volatility_mean")),
            "target_volatility": _coerce_number(metrics.get("target_volatility")),
            "realized_volatility": _coerce_number(metrics.get("realized_volatility")),
            "volatility_target_scale": _coerce_number(metrics.get("volatility_target_scale")),
            "volatility_target_scale_capped": _coerce_number(metrics.get("volatility_target_scale_capped")),
            "max_drawdown_duration": _coerce_number(metrics.get("max_drawdown_duration")),
            "current_drawdown": _coerce_number(metrics.get("current_drawdown")),
            "current_drawdown_duration": _coerce_number(metrics.get("current_drawdown_duration")),
            "value_at_risk": _coerce_number(metrics.get("value_at_risk")),
            "value_at_risk_confidence_level": _coerce_number(metrics.get("value_at_risk_confidence_level")),
            "conditional_value_at_risk": _coerce_number(metrics.get("conditional_value_at_risk")),
            "conditional_value_at_risk_confidence_level": _coerce_number(metrics.get("conditional_value_at_risk_confidence_level")),
        },
        "sanity": sanity,
        "issues": issue_list,
