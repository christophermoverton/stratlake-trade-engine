...
def _render_markdown_report(
    *,
    ...
    lines = [
        ...
        f"- Campaigns: {summary.get('campaign_count', 0)}",
        f"- Campaign Scenarios: {summary.get('campaign_scenario_count', 0)}",
        f"- Candidate Reviews: {summary.get('candidate_review_count', 0)}",
        f"- Candidate Selections: {summary.get('candidate_selection_count', 0)}",
        ...
        _markdown_counts(summary.get("campaign_status_counts")),
        "",
        "## Scenario Status Counts",
        _markdown_counts(summary.get("scenario_status_counts")),
        "",
        "## Candidate Status Counts",
        _markdown_counts(summary.get("candidate_status_counts")),
        "",
        "## Validation",
