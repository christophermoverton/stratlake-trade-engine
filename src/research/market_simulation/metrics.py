...
def _return_metrics(values: Any, tail_quantile: float) -> dict[str, Any]:
    ...
    return {
        ...
        "tail_5pct_return": float(series.quantile(tail_quantile)),
    }
        ...
        rows.append(
            {
                ...
                "tail_5pct_total_return": _quantile(total_returns, config.tail_quantile),
        ...
        rows.append(
            {
                ...
                "tail_5pct_total_return": row["tail_5pct_total_return"],
